...
describe('Record Dividend Transaction (E2E)', () => {
    ...
    test('[POST] /transactions/dividend', async () => {
        ...
        expect(response.headers.location).toMatch(/^\/transactions\/dividend\/[a-zA-Z0-9-]+$/)
