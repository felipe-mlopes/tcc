...
import { TransactionPresenter } from "@/presentation/presenters/transaction-presenter";
...
export class FetchTransactionsHistoryByPortfolioIdController {
  constructor(
    readonly fetchTransactionsHistoryByPortfolioIdService: FetchTransactionsHistoryByPorfolioIdService
  ) {}
