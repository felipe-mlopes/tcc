...
import { InvestmentPresenter } from "@/presentation/presenters/investment-presenter";
...
export class FetchAllInvestmentsByPortfolioIdController {
  constructor(
    readonly fetchAllInvestmentsByPortfolioIdService: FetchAllInvestmentsByPortfolioIdService,
  ) {}
