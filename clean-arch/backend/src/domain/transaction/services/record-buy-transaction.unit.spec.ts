import { RecordBuyTransactionService } from "./record-buy-transaction"
...
let sut: RecordBuyTransactionService

let investor: Investor
let asset: Asset
let portfolio: Portfolio

describe('Record Buy Transaction Service', () => {
    beforeEach(() => {
        ...
        sut = new RecordBuyTransactionService(
    ...
    it('should be able to record buy transaction', async () => {
        ...
        if (result.isRight()) {
            ...
            expect(message).toBe('A transação de compra foi registrada com sucesso')
            ...
            expect(inMemoryTransactionRepository.items[0].transactionType).toBe(TransactionType.Buy)
    ...
    it('should be not able to record with transaction type other than buy', async () => {
    ...
    it('should be not able to record if investor does not exist', async () => {
    ...
    it('should be not able to record if asset does not exist', async () => {
    ...
    it('should be not able to record if portfolio does not exist', async () => {
    ...
    it('should be not able to record if quantity is zero', async () => {
    ...
    it('should be not able to record if price is zero', async () => {
    ...
    it('should be not able to record if fees is zero', async () => {
