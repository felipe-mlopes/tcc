...
import { RecordSellTransactionService } from "./record-sell-transaction"
...
let sut: RecordSellTransactionService

let investor: Investor
let asset: Asset
let portfolio: Portfolio

describe('Record Sell Transaction Service', () => {
    beforeEach(() => {
        ...
        sut = new RecordSellTransactionService(
    ...
    it('should be able to record sell transaction', async () => {
    ...
    it('should be not able to record sell with transaction type other than sell', async () => {
    ...
    it('should be not able to record sell if investor does not exist', async () => {
    ...
    it('should be not able to record sell if asset does not exist', async () => {
    ...
    it('should be not able to record sell if portfolio does not exist', async () => {
    ...
    it('should be not able to record sell if quantity is zero', async () => {
    ...
    it('should be not able to record sell if price is zero', async () => {
    ...
    it('should be not able to record sell if fees is zero', async () => {
